...
export class RegisterComponent {
  ...
  constructor(private router: Router, private service: LoginServiceService) {
    ...
    }, this.passwordMatchValidator); // Apply custom validation for password match
  }
  ...
  onSubmit(): void {
    ...
    if (this.registerForm.valid && !this.isSubmitting) {
      ...
      const user: User = {
        ...
        password: this.registerForm.value.password, // Corrected typo from 'passowrd' to 'password'
        ...
        this.service.addUser(user).subscribe(
          ...
          (error) => {
            ...
            alert('Error occurred while registering the user. Please try again later.');
